  ...
  return (
    <section className="studio-canvas-page">
      <ModuleHeader
        ...
        title="Vedøy Canvas"
        description="Skisser, diagrammer og visuelle arbeidsbøker samlet i Studio. Eksporter som TXT, PDF, PNG, Word og dokumentfiler for Google Docs eller Proton Docs."
        badge="PRIVAT"
      />
