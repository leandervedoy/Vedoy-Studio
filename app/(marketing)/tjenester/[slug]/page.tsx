  ...
  return (
    <main className="service-detail-page">
      ...
      <section className="service-detail-hero">
        <div><Link href="/#tjenester" className="service-back">← Tilbake til tjenestene</Link><p className="editorial-kicker lime">{service.number} · {service.eyebrow}</p><h1>{service.title}<br /><em>bygget ordentlig.</em></h1></div>
        <div className="service-detail-intro"><strong>{service.lead}</strong><p>{service.introduction}</p><Link href={isHosting ? "#konfigurer-hosting" : isShopify ? "#shopify-verktoy" : "/#kontakt"} className="editorial-button">{isHosting ? "Konfigurer hosting" : isShopify ? "Se riktige verktøy" : "Be om et forslag"} <span>↗</span></Link></div>
      </section>
