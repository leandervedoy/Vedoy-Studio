  ...
  return (
    <main className="service-detail-page">
      ...
      <section className="service-detail-hero">
        ...
        <div className="service-detail-intro"><strong>{service.lead}</strong><p>{service.introduction}</p><Link href={isHosting ? "#konfigurer-hosting" : "/#kontakt"} className="editorial-button">{isHosting ? "Bestill hosting" : "Send bestillingsforespørsel"} <span>↗</span></Link></div>
      </section>
      ...
      {isClothing ? <section className="clothing-detail-section"><div><p className="editorial-kicker lime">PROFILPRODUKTER · BESTILL NÅ</p><h2>Velg plagg.<br /><em>Last opp logo.</em></h2><p>Prøv logoen på plaggene under og send en uforpliktende forespørsel med antall, størrelser og ønsket plassering.</p></div><ProductCustomizer /></section> : null}
