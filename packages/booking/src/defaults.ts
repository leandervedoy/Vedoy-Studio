...
export const defaultLabels: Required<BookingLabels> = {
  title: "Bestill time",
...
export const defaultConfiguration: Required<Omit<BookingConfiguration, "customFields">> & Pick<BookingConfiguration, "customFields"> = {
  locale: "nb-NO",
...
export function mergeConfiguration(configuration?: BookingConfiguration) {
  return {
