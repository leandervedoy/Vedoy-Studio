  ...
  return <>
    ...
    {open ? <div className="clothing-modal" role="dialog" aria-modal="true" aria-labelledby="clothing-modal-title">
      ...
      <div className="clothing-modal__panel">
        <header><div><p className="editorial-kicker lime">PROFILPRODUKTER · KOMMER SNART</p><h2 id="clothing-modal-title">Bestillingsskjema</h2></div><button type="button" className="clothing-modal__close" onClick={() => setOpen(false)} aria-label="Lukk">×</button></header>
        <ProductCustomizer />
      </div>
    </div> : null}
  </>;
