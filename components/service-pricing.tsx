...
const pricing: Record<PricingType, PricingConfig> = {
  website: {
    ...
    packages: [
      { label: "01 · LITEN START", price: "ca. 4 750–9 500 kr", description: "En tydelig landingsside eller liten nettside for en lokal bedrift.", includes: ["1–5 sider", "Responsivt design", "Kontaktskjema", "SEO-grunnoppsett", "Publisering"] },
      { label: "02 · BEDRIFTSNETTSIDE", price: "ca. 11 875–28 500 kr", description: "En komplett side som forklarer tjenester og skaper henvendelser.", includes: ["5–10 sider", "Tilpasset design", "Innholdsstruktur", "Skjema eller booking", "Analyse og teknisk SEO"], featured: true },
      { label: "03 · SKREDDERSYDD", price: "Fra ca. 28 500 kr", description: "For bedrifter som trenger CMS, flere språk eller integrasjoner.", includes: ["Skreddersydd designsystem", "CMS og dynamisk innhold", "API-er og integrasjoner", "Avansert SEO", "Utvidet testing"] }
    ],
    examples: [
      { price: "ca. 6 000 kr", description: "Én side for håndverker med tjenester, referanser og kontakt." },
      { price: "ca. 16 000 kr", description: "Seks sider for lokal bedrift med eget uttrykk, tekststruktur og booking." },
      { price: "ca. 37 500 kr", description: "Flerspråklig nettsted med CMS, innholdsmigrering og systemintegrasjon." }
    ],
  ...
  webapp: {
    ...
    packages: [
      { label: "01 · PROTOTYPE", price: "ca. 23 750–38 000 kr", description: "En fokusert løsning som avklarer flyt og tester om idéen skaper verdi.", includes: ["Kjerneflyt og prototype", "Responsivt grensesnitt", "Enkel datamodell", "Testmiljø", "Videre utviklingsplan"] },
      { label: "02 · MVP MED BACKEND", price: "Fra ca. 47 500 kr", description: "En første brukbar versjon med ekte data og funksjoner for pilotkunder.", includes: ["Frontend og backend", "Database", "Innlogging og roller", "Adminflate", "Produksjonssetting"], featured: true },
      { label: "03 · SKALERBART SYSTEM", price: "Fra ca. 190 000 kr", description: "For større arbeidsflyter, flere organisasjoner og krevende integrasjoner.", includes: ["Løsningsarkitektur", "Flere roller og virksomheter", "Betaling eller abonnement", "Integrasjoner og hendelser", "Logging og skaleringsplan"] }
    ],
    examples: [
    ...
    runningPrice: "Fra ca. 950 kr/mnd",
  ...
  store: {
    ...
    packages: [
      { label: "01 · BUTIKKSTART", price: "Fra ca. 47 500 kr", description: "En ryddig nettbutikk med produkter, betaling, frakt og grunnleggende vekstoppsett.", includes: ["Produkt- og kategoristruktur", "Shopify-oppsett", "Betaling og frakt", "Mobil kjøpsreise", "Lansering og opplæring"] },
      { label: "02 · VEKSTBUTIKK", price: "ca. 71 250–142 500 kr", description: "For butikker som trenger eget uttrykk, mer innhold og flere salgssystemer.", includes: ["Tilpasset butikkdesign", "Migrering av produkter", "E-post og analyse", "Flere markeder ved behov", "Utvalgte integrasjoner"], featured: true },
      { label: "03 · HEADLESS COMMERCE", price: "Fra ca. 142 500 kr", description: "Skreddersydd handleopplevelse med Shopify som handelsmotor.", includes: ["Next.js-butikkfront", "Shopify Storefront API", "Skreddersydd designsystem", "Avanserte integrasjoner", "Ytelse og skalering"] }
    ],
    examples: [
    ...
    runningPrice: "Fra ca. 1 425 kr/mnd",
  ...
  general: {
    ...
    packages: [
      { label: "01 · IT-HJELP", price: "ca. 299 kr", description: "En enkel og avgrenset IT-hjelp for bedrift, etter avtale og tilgjengelig kapasitet.", includes: ["Inntil avtalt hjelp per sak", "Feilsøking og veiledning", "PC, mobil eller nett", "Kort oppsummering etterpå"] },
      { label: "02 · DIGITALT PRODUKT", price: "ca. 25 000–95 000 kr", description: "For mindre digitale løsninger, oppdateringer og første versjon av et produkt.", includes: ["Behovsmøte og plan", "Design og utvikling", "Testing og publisering", "Dokumentert overlevering"], featured: true },
      { label: "03 · FULLSKALA APP", price: "fra ca. 95 000 kr", description: "For webapper, mobilapper, desktop-applikasjoner og systemer med backend.", includes: ["Arkitektur og datamodell", "Roller og innlogging", "API, database og integrasjoner", "Pilot og videre driftsplan"] }
    ],
    examples: [
